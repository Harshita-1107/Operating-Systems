...
int main()
{
	...
	if ((dir = opendir ("/home/Documents/os4th/test1")) != NULL) {
	  ...
	  while ((ent = readdir (dir)) != NULL) {
	    ...
	    {
	    	char s[1000];
	    	sprintf(s,"/home/Documents/os4th/test1/%s",ent->d_name);
	    	FILE *fp=fopen(s,"r");
